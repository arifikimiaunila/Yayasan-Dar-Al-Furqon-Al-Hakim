        ...
        <Modal id="cell-attribute-modal" tabIndex={-1} aria-hidden="true" show={openModal} size="md" popup onClose={onCloseModal}>
            ...
            <Modal.Body id="addCellAttributeForm" >
                <div className="space-y-6">
                    <FloatingLabel variant="filled" label="Nama atribut" type="text" name="attribute-name" id="attribute-name" helperText="eg. backgroundColor" />
                    <FloatingLabel variant="filled" label="Nilai atribut" type="text" name="attribute-value" id="attribute-value" helperText="eg. #E1EFFE;" />
