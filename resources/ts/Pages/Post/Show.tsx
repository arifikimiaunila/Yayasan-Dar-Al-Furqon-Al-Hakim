            ...
            <article className="max-w-3xl mx-auto px-4 sm:px-6">
                ...
                <footer className="mt-16 pt-10 border-t border-gray-100">
                    <div className="bg-gray-900 rounded-3xl p-8 text-center text-white shadow-2xl">
                        ...
                        <Link href={route('datayayasan.show', { yayasan_id: 1 }).toString()} className="inline-block bg-white text-gray-900 px-8 py-3 rounded-xl font-black text-sm hover:bg-blue-400 transition-colors uppercase tracking-widest">
                            Donasi Sekarang
                        </Link>
                    </div>
                </footer>
